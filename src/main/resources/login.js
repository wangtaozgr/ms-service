...
function getEncryption(pwd, ui, verifycode, isSafe){
	var p = $.Encryption.getEncryption(pwd, "\x00\x00\x00\x00\x04\xf6\x74\x29", verifycode, isSafe);
	return p;
}